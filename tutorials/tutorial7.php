...
?>
	<div class="tutorial">
		...
		<p>You'll want to navigate to "/var/www/html", delete "index.html", and then put your site files there. Once your files are there, your server ip address should show your website instead of the test page.</p>
	...
	<div class="row">
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
				<a  href="<?php echo $path;?>tutorials/tutorial6.php">Previous Tutorial</a>
			</div></div>
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
			<a  href="<?php echo $path;?>quizzes/quiz7.php">Take the Quiz</a>
			</div></div>
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
				<a  href="<?php echo $path;?>tutorials/tutorial8.php">Next Tutorial</a>
			</div></div>
</div></div>
