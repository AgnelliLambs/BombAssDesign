	...
	<div class="row">
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
				<a  href="<?php echo $path;?>tutorials/tutorial5.php">Previous Tutorial</a>
			</div></div>
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
			<a  href="<?php echo $path;?>quizzes/quiz6.php">Take the Quiz</a>
			</div></div>
		<div class="col-md-4 col-sm-4 centered">
			<div class="circleButton buttonHolder">
				<a  href="<?php echo $path;?>tutorials/tutorial7.php">Next Tutorial</a>
			</div></div>
</div></div>
