...
<div id="bottom">
	<div id="bottomtext">
		<div class="row"> <a href="<?php echo $path;?>about.php" style="color:#b4c1d1;">About Us</a>
			<br> <a href="<?php echo $path;?>citations.php" style="color:#b4c1d1;">Citations</a>
			<br>
			<!--YouNix -->
			<div class="col-xs-6">Site Owners:
				<br> Copyright &copy; YouNix
				<br>
				...
				Email: <a href="mailto:YouNix@gmail.com?subject=Website%20contact" target="_top">YouNix@gmail.com</a>
			...
			<div class="col-xs-6">Site Design By: <br> 
				Copyright &copy; Bomb Ass Design 2017 <br>
				<div id="mobilePhoneLink">Phone: <a href="tel:18005558899" target="_blank">1-800-555-8899</a> <br>
				</div>
