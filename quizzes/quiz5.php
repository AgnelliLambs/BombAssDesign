	...
	<div class="quiz">
		...
		<form>
			...
			<div class="question">
				...
				<label for="h">
					<!-- Correct -->chmod a+x meeting</label>
				<br>
			...
			<div class="question">
				...
				<label for="o">
					<!-- Correct -->771</label>
				<br> </div>
			<input type="button" onclick="checkQuiz(5)" value="Submit"> </form>
	</div>
	<?php
